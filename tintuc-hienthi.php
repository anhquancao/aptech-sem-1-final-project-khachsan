...
?> 
        ...
        <!--end-->
			...
			<div style="display:block;width:790px;float:left;padding:0px;" >
                                            <h1 class="title" style="display:block;margin-top:-30px;margin-left:-30px;"><a href="tintuc.php" style="text-decoration:none">Tin tức</a></h1>
                                            <a href="tintuc.php#phantrang" style="float: right;padding: 10px;margin-top: -25px;" class="phantrang" >Quay về trang tin tức</a>		
                            ...
                            <div class="tintuc" id="newsarea" style="background-color: #D1D6DB;padding-top:10px;padding-right:10px;margin-bottom:20px;border-radius:8px">
                                ...
                                <div class="tintuc-hienthi" style="margin: 20px 0px 0px;" >
                                    <?php
                                        $query="Select DATE_FORMAT(NgayDang, '%b %d, %y ') ,TieuDe,MoTa,NoiDung from tintuc where MaTT={$id} ";
                                        $result=  mysqli_query($link, $query);
                                    ...
                                    <a href="tintuc.php#phantrang" class="phantrang" >Quay về trang tin tức</a>		
                                </div>
