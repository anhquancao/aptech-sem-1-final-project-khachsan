					...
					<div class="box-head">
						...
						<div class="right">
                                                        ...
                                                        <form action="" method="post">
                                                            <input type="submit" class="button" value="Tìm" name="btnSearch" style="float: right;"/>
                                                            <input type="text" placeholder="Nhập tên phòng" onKeyUp="hienthip(document.getElementById('slLP').value,document.getElementById('txtKey').value,1)" class="field small-field" name="txtKey" id="txtKey" style="float: right;"/>
                                                            <select name="slLP" id="slLP" onChange="hienthip(this.value,document.getElementById('txtKey').value,1)" style="float: right;">
    <option value=""> Tất cả </option>
    <?php
        $q5="select MaLP,TenLP from loaiphong";
...
<div style="height: 30px;">
   ...
   {
       echo" <div class='msg msg-ok'>
			<p><strong>Đã xóa phòng!</strong></p>	
		</div>";
   }
...
xmlhttp.open("GET","phong2.php?lp="+lp+"&k="+k+"&p="+p,true)
xmlhttp.send();
}
