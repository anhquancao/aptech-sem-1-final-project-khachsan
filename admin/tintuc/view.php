...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="980px" cellspacing="20">
         <tr><td class="tdleft1" >Tiêu đề tin:</td><td><?php echo $r[1] ?></td></tr>
         <tr><td class="tdleft1" >Hình ảnh:</td><td><img src="../../images/tintuc/<?php echo $r[3] ?>" style="max-width: 300px; max-height: 300px;"/></td></tr>
         <tr><td class="tdleft1" >Trạng thái: </td><td><?php if($r[4] === "0"){echo "Ẩn";}else{echo"Hiện";} ?></td></tr>
         <tr><td class="tdleft1" >Ngày đăng: </td><td><?php echo date('d/m/Y',strtotime($r[5])) ?></td></tr>
         <tr><td class="tdleft1" >Mô tả: </td><td><p style="width: 350px; height: 100%;"><?php echo $r[6] ?></p></td></tr>
         <tr><td class="tdleft1" >Nội dung:</td><td><p style="width: 350px; height: 100%;"><?php echo $r[2] ?></p></td></tr>
          <tr><td></td><td> <div id="spanview" style="margin-left: 300px">
            <?php echo "<a href='edit.php?id={$r[0]}'><img class='tool' title='Sửa' src='../css/images/edit.jpg' width='30px' height='30px'></a>"
                     . "<a href='tintuc.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
