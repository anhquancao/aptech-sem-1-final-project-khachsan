		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Chi tiết Album</h2>
					</div>
					<!-- End Box Head -->	
...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="600px" cellspacing="20">
         <tr><td class="tdleft1">Tên Album:</td><td><?php echo $r[1] ?></td></tr>
         <tr><td class="tdleft1">Ngày tạo: </td><td><?php echo date('d/m/Y',strtotime($r[3])) ?></td></tr>
         <tr><td class="tdleft1">Số ảnh:</td><td><?php echo "<a href='anh.php?id=$id&p=1'>$s[0]</a>"; ?></td></tr>
         <tr><td class="tdleft1">Ảnh đại diện:</td><td><img src="../../images/album/<?php echo $r[4] ?>" style="max-width: 300px; max-height: 300px;"/></td></tr>
         <tr><td class="tdleft1">Mô tả:</td><td><p style="width: 350px; height: 100%"><?php echo $r[2] ?></p></td></tr>
         <tr><td></td><td> <div id="spanview" style="margin-left: 120px">
            <?php echo "<a href='edit.php?id={$r[0]}'><img class='tool' title='Sửa' src='../css/images/edit.jpg' width='30px' height='30px'></a>"
                     . "<a href='album.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
