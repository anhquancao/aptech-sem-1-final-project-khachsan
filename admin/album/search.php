					...
					<div class="box-head">
						...
						<div class="right">
                                                        ...
                                                        <form action="" method="post">
                                                            <label></label><input type="text" placeholder="Nhập tên Album" class="field small-field" name="txtKey" value="<?php if(isset($_REQUEST['key'])){echo $_REQUEST['key'];}?>" <?php if(isset($_REQUEST['key'])){echo"autofocus";} if(isset($_POST['btnAdd'])){echo "autofocus='false'";}?> onfocus="this.select()"/>
...
$query = "select MaAlbum,Album,MoTa,NgayTao,AnhDaiDien from album where 1=1";
if( $k !="")
...
echo "</table>";
 if(mysqli_num_rows($result)<1)
    {
     echo "<br/><br/><br/><br/><div style='font-size: 17px; padding-left: 380px;'>Hiện tại không có Album nào.</div><br/><br/><div style='font-size: 17px; padding-left: 450px;'><a href='album.php?p=1&themmoi=ok' class='add-button'><span>Thêm mới</span></a>
</div>";
    }
    ?>
</div>
...
{echo"<div class='pagging'>
        ...
        <div class='right'>";
             ...
             if($trc>=1){echo"<a href='album.php?p=$trc'>Previous</a>";}
                for($i=1; $i<=$sotrang; $i++)
                 {
                    if($i===$_REQUEST['p'])
                        {
                            echo "<a href='album.php?p=$i'><b>$i</b><a>";
                        }
                    else
                        {
                            echo "<a href='album.php?p=$i'>$i</a> ";
                        }
                 }
                if($sau<=$sotrang){echo"<a href='album.php?p=$sau'>Next</a>";}
