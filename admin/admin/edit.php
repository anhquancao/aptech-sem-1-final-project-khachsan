		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Chỉnh sửa thông tin admin</h2>
					</div>
					<!-- End Box Head -->	

         <script>
             function huy()
             {window.location="admin.php?p=1";}
             function ham()
             {document.getElementById("pass").value="1111"}
         </script>
 ...
 if(isset($_POST['btnUpdate']))
        {
             ...
             $query = "update admin set User='$user',TenNV='$ten',NgaySinh='".date('Y-m-d',strtotime($ns))."',DienThoai='$dt',DiaChi='$dc',Email='$email',Quyen='$quyen'";
             if($pass1!=".....")
             {$query.=",Password='$pass'";}
             $query.=" where MaAD='$id'";
             ...
             {
                 header('location:admin.php?sua=ok&p=1');
             }
                else {
...
?><table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="410px" cellspacing="20">
        <form action="" method="post">
          ...
          <tr><td class="tdleft1">Password:</td><td><input type="password" id="pass"  value="....." name="txtPass"/>&nbsp;&nbsp;<a onclick="ham()"><img title='Reset password (1234567)' src='../css/images/reset.jpg' width='15px' height='15px'></a></td></tr>
          ...
          <tr><td class="tdleft1">Quyền: </td><td><input id="quyen" type="radio" name="txtQuyen" checked="true" value="0"/>&nbsp;Nhân viên&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="quyen" type="radio" name="txtQuyen" value="1"/>&nbsp;Admin</td></tr>
