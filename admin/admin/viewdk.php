			...
			<ul>
			    ...
			    <li><a href="../quangcao/quangcao.php?p=1"><span>Quảng cáo</span></a></li>
                            ...
                            <?php $q = "select * from admin where User='$a' and Quyen=1";
                                  ...
                                  {       
                                  echo "<li><a href='admin.php'  class='active'><span>Quản lý Admin</span></a></li>";
                                  }
                            ?>
			</ul>
		</div>
		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Thông tin admin</h2>
					</div>
					<!-- End Box Head -->	
...
<script>
    function check(id)
    {
        if(confirm("Bạn có thực sự muốn xóa đơn đăng ký này?")===true)
            {
     ...
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="350px" cellspacing="20">
         ...
         <tr><td class="tdleft1">Ngày Gửi:</td><td><?php echo date('d/m/Y',strtotime($r[10])) ?></td></tr>
         <tr><td></td><td> <div id="spanview" style="margin-left: -15px">
            <?php echo "<a href='adddk.php?id={$r[0]}'><img class='tool' title='Thêm admin' src='../css/images/adduser.jpg' width='30px' height='30px'></a>"
                     . "<a <a onclick="."check('$r[0]')"." href='#'><img class='tool' title='Xóa' src='../css/images/delete1.jpg' width='30px' height='30px'></a>"
                     . "<a href='dsdangky.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>";
            ?>
            </div></td></tr>
     </table>
