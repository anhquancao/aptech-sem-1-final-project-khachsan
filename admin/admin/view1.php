...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="350px" cellspacing="20">
         ...
         <tr><td class="tdleft1">Trạng thái:</td><td><?php if($r[8]==='1'){echo "<img title='online' src='../css/images/online.jpg' width='30px' height='30px'/>";}else{echo "<img title='offline' src='../css/images/offline.jpg' width='30px' height='30px'/>";}; ?></td></tr>
         <tr><td class="tdleft1">Quyền:</td><td><?php if( $r[9]==='0'){ echo"Nhân viên";}else{echo"Admin";}?></td></tr>
         <tr><td></td><td> <div id="spanview">
            <?php echo "<a href='edit.php?id={$r[0]}'><img class='tool' title='Sửa' src='../css/images/edit.jpg' width='30px' height='30px'></a>"
                     . "<a href='admin.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
