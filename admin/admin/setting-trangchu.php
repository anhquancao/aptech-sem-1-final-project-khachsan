			...
			<div id="content">
				...
				<!-- Box -->
					...
					<ul class="setting-nav">
						<li class="setting-selected"><a href="setting-trangchu.php">Trang Chủ</a></li>
...
<li></li>
					<?php
						...
						if (mysqli_num_rows($result1)>0){
							while ($r1=mysqli_fetch_array($result1))
							{
								...
								if ($count==0) $title1=$r1[0];						
								if ($count==1) $des1=$r1[0];
								$count+=1;
							}
						}
					?>
			...
			<p><strong>Chỉnh sửa thành công!</strong></p>	
							...
							$querry_setting="update setting set content='{$title}' where id=1 ";
							mysqli_query($link,$querry_setting);
							$querry_setting="update setting set content='{$des}' where id=2 ";
							mysqli_query($link,$querry_setting);
								}
							}
							?>				
						...
						<tr>
							<td class="setting-content-left">Mô tả khách sạn</td>
