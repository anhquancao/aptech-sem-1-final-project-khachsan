			...
			<div id="content">
				...
				<!-- Box -->
					...
					<ul class="setting-nav">
						...
						<li class="setting-selected"><a href="setting-dichvu.php">Dịch Vụ</a></li>
...
<li></li>
					<?php
						...
						if (mysqli_num_rows($result1)>0){
							while ($r1=mysqli_fetch_array($result1))
							{
								...
								if ($count==5) $title1=$r1[0];						
								if ($count==6) $des1=$r1[0];
								if ($count==7) $sophong1=$r1[0];
								$count+=1;
							}
						}	
			...
			<p><strong>Bạn phải nhập đủ các trường !</strong></p>	
							...
							$querry_setting="update setting set content='{$title}' where id=6" ;
							mysqli_query($link,$querry_setting);
							
							$querry_setting="update setting set content='{$des}' where id=7 ";
							mysqli_query($link,$querry_setting);
						
							$querry_setting="update setting set content='{$sophong}' where id=8 ";
			...
			<p><strong>Chỉnh sửa thành công!</strong></p>	
						...
						<tr>
							<td class="setting-content-left">Mô tả chung về dịch vụ</td>
						...
						<tr>
							<td class="setting-content-left">Số dịch vụ hiển thị trên 1 trang</td>
...
`											
								...
								<?php if(isset($_POST['sophong']) && $_POST['sophong']==0) echo "<span style=\"color:red\">Mời chọn só dịch vụ</span>" ;?>						
							</td> 
						</tr>								
