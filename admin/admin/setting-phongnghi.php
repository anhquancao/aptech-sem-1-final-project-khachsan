			...
			<div id="content">
				...
				<!-- Box -->
					...
					<ul class="setting-nav">
						...
						<li class="setting-selected"><a href="setting-phongnghi.php">Phòng Nghỉ</a></li>
...
<li></li>
					<?php
						...
						if (mysqli_num_rows($result1)>0){
							while ($r1=mysqli_fetch_array($result1))
							{
								...
								if ($count==2) $title1=$r1[0];						
								if ($count==3) $des1=$r1[0];
								if ($count==4) $sophong1=$r1[0];
								$count+=1;
							}
						}	
					...
					<table class="setting-content">
						...
						<td colspan="2">
							...
							{
								if ($_POST['title']=="" || $_POST['description']=="" || $_POST['sophong']=="")
								{
			...
			<p><strong>Bạn phải nhập đủ các trường !</strong></p>	
							...
							$querry_setting="update setting set content='{$title}' where id=3" ;
							mysqli_query($link,$querry_setting);
							
							$querry_setting="update setting set content='{$des}' where id=4 ";
							mysqli_query($link,$querry_setting);
						
							$querry_setting="update setting set content='{$sophong}' where id=5 ";
			...
			<p><strong>Chỉnh sửa thành công!</strong></p>	
						...
						<tr>
							<td class="setting-content-left">Mô tả chung về phòng nghỉ </td>
						...
						<tr>
							<td class="setting-content-left">Số phòng hiển thị trên 1 trang</td>
							<td class="setting-content-right"><input type="number" name="sophong" id="sophong" value= "<?php  if(isset($_POST['sophong'])) echo $_POST['sophong']; else if (isset($title1)) echo $sophong1; ?>" ><span style="color:red"><?php if (isset($_POST['sophong']) && !is_numeric($_POST['sophong'])) echo "Bạn cần nhập số" ?></span> </td>
						</tr>								
