			...
			<div id="content">
				...
				<!-- Box -->
					...
					<ul class="setting-nav">
						...
						<li class="setting-selected"><a href="setting-thuvien.php">Thư Viện</a></li>
						<li><a href="setting-lienhe.php">Liên Hệ</a></li>
<li></li>
					<?php
						$count=0;
						...
						if (mysqli_num_rows($result1)>0){
							while ($r1=mysqli_fetch_array($result1))
							{
								...
								if ($count==10) $title1=$r1[0];						
								if ($count==11) $des1=$r1[0];
								if ($count==12) $sophong1=$r1[0];
								$count+=1;
							}
						}	
					...
					<form method="Post">
					<table class="setting-content">
						<tr  >
						<td colspan="2">
							<?php 
							if (isset($_POST['btnSubmit']))
							{
								if ($_POST['title']=="" || $_POST['description']=="" || $_POST['sophong']==0)
								{
			...
			<p><strong>Bạn phải nhập đủ các trường !</strong></p>	
							...
							$querry_setting="update setting set content='{$title}' where id=11" ;
							mysqli_query($link,$querry_setting);
							
							$querry_setting="update setting set content='{$des}' where id=12 ";
							mysqli_query($link,$querry_setting);
						
							$querry_setting="update setting set content='{$sophong}' where id=13 ";
			...
			<p><strong>Chỉnh sửa thành công!</strong></p>	
						...
						<tr>
							<td class="setting-content-left">Mô tả chung về Thư Viện</td>
						...
						<tr>
							<td class="setting-content-left">Số album hiển thị trên 1 trang</td>
							<td class="setting-content-right">
								<select name="sophong" id="sophong" >
									<option  value="0">Mời chọn</option>
									<option <?php if(isset($sophong1) && $sophong1==3) echo'selected="selected"';else if(isset($_POST['sophong']) && $_POST['sophong']==3) echo'selected="selected"';   ?> value="3">3</option>
									<option <?php if(isset($sophong1) && $sophong1==6) echo'selected="selected"';else if(isset($_POST['sophong']) && $_POST['sophong']==6) echo'selected="selected"'; ?> value="6">6</option>
									<option <?php if(isset($sophong1) && $sophong1==9) echo'selected="selected"';else if(isset($_POST['sophong']) && $_POST['sophong']==9) echo'selected="selected"'; ?> value="9">9</option>								
`											
								</select>	
								<?php if(isset($_POST['sophong']) && $_POST['sophong']==0) echo "<span style=\"color:red\">Mời chọn só album</span>" ;?>						
							</td> 
						</tr>								
