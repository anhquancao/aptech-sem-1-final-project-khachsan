			...
			<div id="content">
				...
				<!-- Box -->
					...
					<ul class="setting-nav">
						...
						<li class="setting-selected"><a href="setting-tintuc.php">Tin Tức</a></li>
...
<li></li>
					<?php
						...
						if (mysqli_num_rows($result1)>0){
							while ($r1=mysqli_fetch_array($result1))
							{
								...
								if ($count==8) $title1=$r1[0];						
								
								if ($count==9) $sophong1=$r1[0];
								$count+=1;
							}
						}	
			...
			<p><strong>Bạn phải nhập đủ các trường !</strong></p>	
							...
							$querry_setting="update setting set content='{$title}' where id=9" ;
							mysqli_query($link,$querry_setting);
							
			
						
							$querry_setting="update setting set content='{$sophong}' where id=10 ";
			...
			<p><strong>Chỉnh sửa thành công!</strong></p>	
						...
						<tr>
							<td class="setting-content-left">Số tin tức hiển thị trên 1 trang</td>
