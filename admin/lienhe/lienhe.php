					...
					<div class="box-head">
						...
						<div class="right">
                                                        ...
                                                        <form action="" method="post">
                                                            <label></label><input type="text" placeholder="Nhập tên liên hệ" class="field small-field" name="txtKey" id="txtKey" onKeyUp="hienthilh(document.getElementById('txtKey').value,1)"  value="<?Php if(isset($_REQUEST['k'])) echo $_REQUEST['k']; ?>"/>
...
<div style="height: 30px;">
   ...
   {
       echo" <div class='msg msg-ok'>
			<p><strong>Đã xóa liên hệ!</strong></p>	
		</div>";
   }
...
xmlhttp.open("GET","lienhe2.php?k="+k+"&p="+p,true)
xmlhttp.send();
}
...
<div id="data_load" style="height: 450px;"></div>
</div>					
				</div>
				<!-- End Box -->
