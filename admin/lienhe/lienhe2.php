...
if($k!='')
 $trang.=" where 1=1 and TenLH like '%$k%'";
...
$query = "select * from lienhe where 1=1 ";
if ($k!='')
...
if(mysqli_num_rows($result)>0)
{
    while($r= mysqli_fetch_array($result))
    {
        echo "<tr>
            ...
            <td>"; if($r[5]==="1"){echo" readed ";} else{echo"<b>Unread</b>";} echo"</td>    
            <td>
                  <div class='btn'>
        ...
        <div class='right'>";
            ...
            if($sotrang>1)
            {
             if($trc>=1)
                 {
                 ?>
                 <a href="#" onclick="hienthilh('<?php echo $k?>','<?php echo $trc?>')"> Trước </a>
                <?php
                 }
                 for($i=1; $i<=$sotrang; $i++)
                 {
                    if($i===$_REQUEST['p'])
                        ...
                        {
                        ?>
                        <a href="#" onclick="hienthilh('<?php echo $k?>',<?php echo $i?>)"> <?php echo $i?> </a>
                        <?php    
                        }
                 }
                if($sau<=$sotrang)
                    {
                    ?>
                    <a href="#" onclick="hienthilh('<?php echo $k?>','<?php echo $sau?>')"> Sau </a>
                    <?php
                    }
            }
        echo"</div></div>";
