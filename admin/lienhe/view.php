		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Chi tiết liên hệ</h2>
					</div>
					<!-- End Box Head -->	
...
{
    $id=$_REQUEST['id'];
    $trangthai="update lienhe set TrangThai='1' where MaLH=$id";
    mysqli_query($link,$trangthai);
    $query="select * from lienhe where MaLH='$id'";
...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="400px" cellspacing="20">
         <tr><td class="tdleft1">Tên liên hệ:</td><td><?php echo $r[1] ?></td></tr>
         <tr><td class="tdleft1">Số điện thoại:</td><td><?php echo $r[2] ?></td></tr>
         <tr><td class="tdleft1">Email:</td><td><?php echo $r[3] ?></td></tr>
         <tr><td class="tdleft1">Ngày gửi:</td><td><?php echo date('d/m/Y',strtotime($r[6])) ?></td></tr>
         <tr><td class="tdleft1">Nội dung:</td><td><?php echo $r[4] ?></td></tr>
         <tr><td></td><td> <div id="spanview" style="margin-left:200px">
            <?php echo "<a href='lienhe.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
