		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Chi tiết quảng cáo</h2>
					</div>
					<!-- End Box Head -->	
...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px" width="450px" cellspacing="20">
         <tr><td class="tdleft1">Tên quảng cáo:</td><td><?php echo $r[1] ?></td></tr>
         <tr><td class="tdleft1">Hình ảnh: </td><td><img src="../../images/quangcao/<?php echo $r[3] ?>" style="max-width: 300px; max-height: 300px;"/></td></tr>
         <tr><td class="tdleft1">Liên kết:</td><td><?php echo $r[2] ?></td></tr>
         <tr><td></td><td> <div id="spanview" style="margin-left: 55px">
            <?php echo "<a href='edit.php?id={$r[0]}'><img class='tool' title='Sửa' src='../css/images/edit.jpg' width='30px' height='30px'></a>"
                     . "<a href='quangcao.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
