					...
					<div class="box-head">
						...
						<div class="right">
                                                        ...
                                                        <form action="" method="post">
                                                            <label></label><input type="text" placeholder="Nhập tên quảng cáo" class="field small-field" id="txtKey" onKeyUp="hienthiqc(document.getElementById('txtKey').value,1)" name="txtKey"/>
...
<div style="height: 30px;">
   ...
   {
       echo" <div class='msg msg-ok'>
			<p><strong>Đã xóa quảng cáo!</strong></p>	
		</div>";
   }
...
xmlhttp.open("GET","quangcao2.php?k="+k+"&p="+p,true)
xmlhttp.send();
}
