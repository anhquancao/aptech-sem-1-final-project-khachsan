		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box -->
					...
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Chi tiết loại phòng</h2>
					</div>
					<!-- End Box Head -->	
...
{
    $id=$_REQUEST['id'];
    $query="select * from loaiphong where MaLP='$id'";
...
?>
     <table border="2" style="margin: auto; border-radius: 20px; margin-bottom: 10px; margin-top: 10px;" width="500px" cellspacing="20">
         <tr><td class="tdleft1" style="width: 150px;">Tên loại phòng:</td><td><?php echo $r[1] ?></td></tr>
         <tr><td class="tdleft1" style="width: 150px;">Số phòng hiện có: </td><td><?php $soluong="select count(Map) from phong where MaLP=$id";
                                                                                $soluong1=mysqli_query($link, $soluong);
                                                                                $soluong2=mysqli_fetch_array($soluong1);
                                                                                echo "<a href=../phong/phong.php?p=1&lp=$id>$soluong2[0]</a>"; ?></td></tr>
         <tr><td class="tdleft1" style="width: 150px;">Hình ảnh:</td><td><img src="../../images/loaiphong/<?php echo $r[2] ?>" style="max-width: 300px; max-height: 300px;"></td></tr>
         <tr><td class="tdleft1" style="width: 150px;">Đơn giá: </td><td><?php echo number_format($r[4]) ?></td></tr>
         <tr><td class="tdleft1" style="width: 150px;">Thông tin:</td><td><p style="width: 300px; height: 100%"<?php echo $r[3] ?></td></tr>
         <tr><td></td><td> <div id="spanview" style="margin-left: 45px">
            <?php echo "<a href='edit.php?id={$r[0]}'><img class='tool' title='Sửa' src='../css/images/edit.jpg' width='30px' height='30px'></a>"
                     . "<a href='loaiphong.php?p=1'><img class='tool' title='Trở lại' src='../css/images/back.jpg' width='30px' height='30px'></a>"
            ?>
            </div></td></tr>
     </table>
